...
### Un-adjusted Semi-parametric Model
```
<<dd_do>>
...
### Semi-parametric Adjusted for Age and Gender
...
```
<<dd_do>>
graph combine semipara_unadj.gph semipara_adj.gph, rows(1) xcommon ti("Figure: Unadjusted vs. Adjusted Hazard Ratio (95% CI)")
